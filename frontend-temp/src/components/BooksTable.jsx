    ...
    <table className='w-full border-seperate border-spacing-2'>
          <thead>
            <tr>
              ...
              <th className='border border-slate-600 rounded-md max-mad:hidden'>Author</th>
              <th className='border border-slate-600 rounded-md max-mad:hidden'>Publish Year</th>
              ...
              <tr key={book._id} className='h-8'>
               ...
               <td className='border border-slate-700 rounded-md text-center'>
                <div className='flex justify-center gap-x-4 '>
                 <Link to={`/books/details/${book._id}`}><BiInfoCircle className='text-2xl text-green-800' /></Link>
